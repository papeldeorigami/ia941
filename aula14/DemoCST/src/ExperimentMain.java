...
public class ExperimentMain {
        ...
        public ExperimentMain(int scenario) {
                //WS3DProxy.logger.setLevel(Level.SEVERE);
                Logger.getLogger("codelets").setLevel(Level.SEVERE);
                // Create Environment
                Environment env=new Environment(scenario); //Creates only a creature and some apples
	...
	public static void main(String[] args) {
		...
		ExperimentMain em = new ExperimentMain(scenario);
	}
